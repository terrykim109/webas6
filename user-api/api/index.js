...
// A simple root route to confirm the API is working
app.get("/", (req, res) => {
  res.json({ message: "Hello, Vercel! Your API is working." });
});

// For all other routes, send a 404 Not Found error
app.use((req, res) => {
  res.status(404).json({
    error: "Not found",
    attemptedPath: req.path,
...
// The Vercel serverless handler function
// It exports the Express app directly, which is a common pattern for Vercel
module.exports = app;
